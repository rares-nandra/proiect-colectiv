    ...
    return (
        <div
            ...
            style={{
                ...
                width: customizations?.width ? customizations?.width : "280px",
                height: customizations?.height ? customizations?.height : "375px",
            ...
            <div className={styles.contentContainer}>
                    ...
                    <div className={styles.tagsContainer}>
                        {product.keywords.map((keyword, index) => (
                            <div
                                ...
                                style={{
                                    backgroundColor: keyword.match
                                        ? customizations?.backgroundAccent
                                        : customizations?.backgroundColorTags,
                                }}
                            >
                                <p
                                    className={styles.tag}
                                    style={{ color: customizations?.foregroundAccent }}
                                >
                                    {keyword.name}
                                </p>
                            </div>
                ...
                <div className={styles.priceContainer}>
                    <p
                        ...
                        style={{ color: customizations?.backgroundAccent }}
                    >
                        {product.price} RON
                    </p>
